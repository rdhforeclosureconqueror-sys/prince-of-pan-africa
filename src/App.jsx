  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/societies/:societyId/member-home" element={<SocietyBuilderRoute authChecked={authChecked} user={user} rbac={rbac}><SocietyMemberHomePage /></SocietyBuilderRoute>} />
        ...
        <Route path="/societies/:societyId/predictive" element={<SocietyBuilderRoute authChecked={authChecked} user={user} rbac={rbac}><PredictiveIntelligencePage user={user} rbac={rbac} /></SocietyBuilderRoute>} />
        ...
        {ENABLE_MUTUAL_AID_DOCUMENTATION ? (
          <Route path="/admin/mutual-aid/completion" element={isAdmin ? <MutualAidDocumentationDashboard /> : <PilotDeferredPage title="Mutual Aid documentation is admin-only" />} />
        ) : null}
