...
export const SIMBA_APPLICATIONS = [
  ...
  { id: "preparedness", icon: "🛡️", name: "Community Preparedness", description: "Household and community readiness pathways for resilience and coordinated response.", purpose: "Strengthen your household and community resilience.", status: APPLICATION_STATUSES.comingSoon, category: "Preparedness" },
