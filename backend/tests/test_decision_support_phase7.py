...
class DecisionSupportPhase7Tests(unittest.TestCase):
    ...
    def test_deterministic_health_fixture_score_matches_preserved_baseline(self):
        ...
        try:
            ...
            upstream_scores = [o["priority_score"] for o in data["debug"]["opportunity_intelligence"]["opportunities"]]
        ...
        self.assertEqual(all_scores, upstream_scores)
        self.assertEqual(data["diagnostic"]["score_inputs"], all_scores)
