...
class SocietyTrustTask(Base):
    ...
    source_book_slug: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    source_book_id: Mapped[int | None] = mapped_column(ForeignKey("audiobooks.id"), nullable=True, index=True)
    source_section_id: Mapped[int | None] = mapped_column(ForeignKey("audiobook_chapters.id"), nullable=True, index=True)
    source_chapter_slug: Mapped[str] = mapped_column(String(255), nullable=False, default="")
    source_chapter_label: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    source_reader_path: Mapped[str] = mapped_column(Text, nullable=False, default="")
    source_reference_type: Mapped[str] = mapped_column(String(64), nullable=False, default="")
