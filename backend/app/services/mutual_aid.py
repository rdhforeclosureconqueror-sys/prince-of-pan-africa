...
def mutual_aid_feature_flags() -> dict[str, bool]:
    return {
        ...
        "MUTUAL_AID_PILOT_LAUNCH_LOCK_ENABLED": settings.MUTUAL_AID_PILOT_LAUNCH_LOCK_ENABLED,
        "MUTUAL_AID_PILOT_RUNBOOK_ENABLED": settings.MUTUAL_AID_PILOT_RUNBOOK_ENABLED,
        "MUTUAL_AID_PILOT_SMOKE_TESTS_ENABLED": settings.MUTUAL_AID_PILOT_SMOKE_TESTS_ENABLED,
        "MUTUAL_AID_ANALYTICS_ENABLED": settings.MUTUAL_AID_ANALYTICS_ENABLED,
        "MUTUAL_AID_OBSERVABILITY_ENABLED": settings.MUTUAL_AID_OBSERVABILITY_ENABLED,
        "MUTUAL_AID_DOCUMENTATION_ENABLED": settings.MUTUAL_AID_DOCUMENTATION_ENABLED,
    }
